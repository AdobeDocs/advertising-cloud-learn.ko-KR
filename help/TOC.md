...
+ [!DNL Analytics for Advertising Cloud] {#analytics}
   + [소개 [!DNL Analytics for Advertising Cloud]](/help/integrations/analytics/intro-a4adc.md)
   ...
   + [소개 [!DNL Analysis Workspace] Advertising Cloud 데이터 보고용](/help/integrations/analytics/analytics-analysis-workspace-a4adc.md)
   + [Advertising Cloud 마케팅 채널을 사용한 보고](/help/integrations/analytics/analytics-reporting-a4adc.md)
   + [만들기 [!DNL Analytics] Advertising Cloud 활성화 및 보고를 위한 프로필](/help/integrations/analytics/analytics-profiles-a4adc.md)
   ...
   + [만들기 [!DNL Analytics] Advertising Cloud 데이터를 사용한 사용자 지정 지표](/help/integrations/analytics/analytics-custom-metrics-a4adc.md)
